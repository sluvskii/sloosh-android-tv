...
/**
 * Static holder so the PlayerActivity / PlayerScreen can access the active
 * [AllohaSessionManager] that was created by DetailsScreen / PlayerViewModel.
 *
 * The proxy URL (127.0.0.1:$port/master.m3u8) never changes; only
 * the upstream CDN URL is swapped when the user picks a different
 * translation inside the player or quality.
 */
