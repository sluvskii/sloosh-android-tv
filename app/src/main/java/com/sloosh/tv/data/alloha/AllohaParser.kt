...
class AllohaParser(context: Context) {
    ...
    private var uaIndex = (0 until userAgents.size).random()
                    ...
                    try {
                        ...
                        function checkDone() {
                            ...
                            for (var k in capturedHeaders) {
                                if (k === 'authorizations' || k === 'authorization') hasAuth = true;
                                if (k === 'accepts-controls' || k === 'accepts-control') hasAccept = true;
                            }
